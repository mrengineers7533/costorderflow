import { LayoutGrid, FileText, Menu, ClipboardList, Receipt, ChevronLeft, ChevronRight, ShieldCheck, LogOut, BarChart3, Workflow, ShoppingCart, Factory, ClipboardCheck } from "lucide-react";
